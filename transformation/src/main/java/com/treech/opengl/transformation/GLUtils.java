...
public class GLUtils {
    ...
    public static int loadTextureFromBitmap(Bitmap bitmap) {
        ...
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D,
                GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR);//纹理被放大的时候使用邻近过滤
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D,
                GLES20.GL_TEXTURE_MIN_FILTER, GLES20.GL_LINEAR);//纹理被缩小的时候使用邻近过滤
        //设置纹理的环绕方式（s、t、r等价于x、y、z）
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D,
                GLES20.GL_TEXTURE_WRAP_S, GLES20.GL_CLAMP_TO_EDGE);//超出边缘裁剪
        GLES20.glTexParameterf(GLES20.GL_TEXTURE_2D,
